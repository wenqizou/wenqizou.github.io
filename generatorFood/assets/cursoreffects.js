  ...
  return (
      ...
      function w(e, t, i) {
        ...
        ;(this.initialLifeSpan = n),
          ...
          (this.update = function (e) {
            ...
            const t =
              0.2 +
              (this.initialLifeSpan - this.lifeSpan) / this.initialLifeSpan
            ;(e.fillStyle = '#e6f1f7'),
    ...
    (e.clockCursor = function (e) {
      ...
      function z() {
        ...
        for (let e = 0; e < D; e++)
          (b[e] = 0), (R[e] = 0), (Y[e] = 0), (S[e] = 0)
        for (let e = 0; e < y.length; e++) T[e] = { color: d, value: y[e] }
        for (let e = 0; e < w.length; e++) X[e] = { color: r, value: w[e] }
        ...
        !(function () {
          ...
          (function () {
            ...
            const e = new Date(),
              ...
              d =
                (Math.PI * (l - 3)) / 6 +
                (Math.PI * parseInt(e.getMinutes())) / 360
            for (let e = 0; e < T.length; e++)
              (T[e].y = b[e] + 67.5 * Math.sin(-n + (e * L * Math.PI) / 180)),
                (T[e].x = R[e] + 67.5 * Math.cos(-n + (e * L * Math.PI) / 180)),
                (i.fillStyle = T[e].color),
                i.fillText(T[e].value, T[e].x, T[e].y)
            for (let e = 0; e < X.length; e++)
              (X[e].y =
                b[T.length + e] + 45 * Math.sin((e * M * Math.PI) / 180)),
                (X[e].x =
                  R[T.length + e] + 45 * Math.cos((e * M * Math.PI) / 180)),
                (i.fillStyle = X[e].color),
                i.fillText(X[e].value, X[e].x, X[e].y)
            for (let e = 0; e < I.length; e++)
              (I[e].y = b[T.length + v + e] + 0 + e * B * Math.sin(d)),
                (I[e].x = R[T.length + v + e] + 0 + e * B * Math.cos(d)),
                (i.fillStyle = I[e].color),
                i.fillText(I[e].value, I[e].x, I[e].y)
            for (let e = 0; e < H.length; e++)
              (H[e].y =
                b[T.length + v + I.length + e] + 0 + e * B * Math.sin(s)),
                (H[e].x =
                  R[T.length + v + I.length + e] + 0 + e * B * Math.cos(s)),
                (i.fillStyle = H[e].color),
                i.fillText(H[e].value, H[e].x, H[e].y)
            for (let e = 0; e < W.length; e++)
              (W[e].y =
                b[T.length + v + I.length + H.length + e] +
                0 +
                e * B * Math.sin(n)),
                (W[e].x =
                  R[T.length + v + I.length + H.length + e] +
                  0 +
                  e * B * Math.cos(n)),
    ...
    (e.ghostCursor = function (e) {
      ...
      function m(e) {
        if (e.touches.length > 0)
          for (let t = 0; t < e.touches.length; t++)
            f(e.touches[t].clientX, e.touches[t].clientY, r)
      }
      function g(e) {
        if (o) {
          const t = s.getBoundingClientRect()
    ...
    (e.rainbowCursor = function (e) {
      ...
      function p(e) {
        ...
        if (!1 === u) {
          u = !0
          for (let e = 0; e < r; e++)
            (t = l.x), (i = l.y), void 0, d.push(new v(t, i))
        }
        var t, i
      }
      function y() {
    ...
    (e.snowflakeCursor = function (e) {
      ...
      function f(e) {
        ...
        p(d.x, d.y, a[Math.floor(Math.random() * h.length)])
      }
      function p(e, t, i) {
        r.push(new v(e, t, i))
      }
      function y() {
        !(function () {
          if (0 != r.length) {
            ...
            0 == r.length && i.clearRect(0, 0, c, l)
          }
        })(),
          (n = requestAnimationFrame(y))
      }
    ...
    (e.springyEmojiCursor = function (e) {
      ...
      function g(e) {
        if (e.touches.length > 0)
          if (h) {
            ...
            ;(r.x = e.touches[0].clientX - t.left),
              (r.y = e.touches[0].clientY - t.top)
          } else (r.x = e.touches[0].clientX), (r.y = e.touches[0].clientY)
      }
      function f(e) {
        if (h) {
          const t = c.getBoundingClientRect()
      ...
      function p() {
        !(function () {
          ;(t.width = t.width), (a[0].position.x = r.x), (a[0].position.y = r.y)
          for (let e = 1; e < 7; e++) {
            let n = new w(0, 0)
            ...
            ;(a[e].velocity.x += 0.01 * c.X),
              ...
              a[e].position.y >= o - 11 - 1 &&
                (a[e].velocity.y > 0 &&
                  (a[e].velocity.y = 0.7 * -a[e].velocity.y),
                (a[e].position.y = o - 11 - 1)),
              a[e].position.x >= s - 11 &&
                (a[e].velocity.x > 0 &&
                  (a[e].velocity.x = 0.7 * -a[e].velocity.x),
    ...
    (e.textFlag = function (e) {
      ...
      for (let e = 0; e < c.length; e++)
        u[e] = { letter: c.charAt(e), x: m / 2, y: m / 2 }
      e?.size
      ...
      function v(e) {
        if (s) {
          ...
          ;(f.x = e.clientX - t.left), (f.y = e.clientY - t.top)
        } else (f.x = e.clientX), (f.y = e.clientY)
      }
      function x() {
        !(function () {
    ...
    (e.trailingCursor = function (e) {
      ...
      function y(e) {
        ...
        if (!1 === u) {
          u = !0
          for (let e = 0; e < r; e++)
            (t = l.x), (i = l.y), (n = m), d.push(new x(t, i, n))
        }
        var t, i, n
      }
      function w() {
